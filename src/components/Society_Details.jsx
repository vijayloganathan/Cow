...
export default function Society_Details() {
  ...
  const fetchData = async () => {
    try {
      const res = await axios.get("https://cow-health-prediction-backend.onrender.com/get_society_details");
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post("https://cow-health-prediction-backend.onrender.com/Society_Details_Update", values)
      .then((res) => {
